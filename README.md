...
Windows системы для использования бухгалтерским отделом.
	Слишком размытое понятие системы, о чем речь? 1с? (база, сервер приложений)
Системы, выполняющие высокопроизводительные расчеты на GPU.
	Для этих систем скорее всего лучше использовать физический сервер для доступа к GPU без прослоек.
